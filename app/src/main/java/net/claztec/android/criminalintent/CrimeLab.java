...
public class CrimeLab {
    ...
    public File getPhotoFile(Crime crime) {
        File exteralFilesDir = mContext.getExternalFilesDir(Environment.DIRECTORY_PICTURES);
        if (exteralFilesDir == null) {
            return null;
        }
        return new File(exteralFilesDir, crime.getPhotoFilename());
    }
}
